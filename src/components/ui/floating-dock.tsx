  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="h-10 w-10 rounded-full bg-gray-950 dark:bg-neutral-800 flex items-center justify-center"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end  rounded-2xl bg-gray-950 dark:bg-neutral-900 px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
